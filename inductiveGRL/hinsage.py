...
class HinSAGE_Representation_Learner_Ind_TB:
...
class HinSAGE_Representation_Learner_Not_TB:
    ...
    def train_hinsage(self, S, node_identifiers, label, batch_size, epochs, start_time, end_time):
        ...
        validation_node_identifiers = node_identifiers[round(0.8*len(node_identifiers)):]
        validation_labels = label.loc[validation_node_identifiers]
        generator = TimeHinSAGENodeGenerator(S, batch_size, self.num_samples, head_node_type=self.embedding_for_node_type, start_time=start_time, end_time=end_time)
        train_gen = generator.flow(train_node_identifiers, train_labels, shuffle=True)
        test_gen = generator.flow(validation_node_identifiers, validation_labels)
...
class HinSAGE_Representation_Learner_Nrecentfast_Filter:
    ...
    def train_hinsage(self, S, node_identifiers, label, batch_size, epochs, start_time, end_time):
        ...
        validation_node_identifiers = node_identifiers[round(0.8*len(node_identifiers)):]
        validation_labels = label.loc[validation_node_identifiers]
        generator = NrecentfastFilterHinSAGENodeGenerator(S, batch_size, self.num_samples, head_node_type=self.embedding_for_node_type, start_time=start_time, end_time=end_time)
        train_gen = generator.flow(train_node_identifiers, train_labels, shuffle=True)
        test_gen = generator.flow(validation_node_identifiers, validation_labels)
...
class HinSAGE_Representation_Learner_Nrecent:
    ...
    def train_hinsage(self, S, node_identifiers, label, batch_size, epochs):
        ...
        validation_node_identifiers = node_identifiers[round(0.8*len(node_identifiers)):]
        validation_labels = label.loc[validation_node_identifiers]
        generator = NrecentHinSAGENodeGenerator(S, batch_size, self.num_samples, head_node_type=self.embedding_for_node_type)
        train_gen = generator.flow(train_node_identifiers, train_labels, shuffle=True)
        test_gen = generator.flow(validation_node_identifiers, validation_labels)
...
class HinSAGE_Representation_Learner_Memory:
    ...
    def __init__(self, embedding_size, num_samples, embedding_for_node_type, S, batch_size):
...
class HinSAGE_Representation_Learner_Memory_Time_Weighted:
    ...
    def __init__(self, embedding_size, num_samples, embedding_for_node_type, S, batch_size):
        ...
        # HinSAGE model
        generator = TimeWeightedHinSAGENodeGenerator(S, batch_size, self.num_samples, head_node_type=self.embedding_for_node_type)
        self.model = HinSAGE(layer_sizes=[self.embedding_size]*len(self.num_samples), generator=generator, dropout=0)
        x_inp, x_out = self.model.build()
