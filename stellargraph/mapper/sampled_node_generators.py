...
__all__ = [
    ...
    "TimeHinSAGENodeGenerator",
    "NrecentHinSAGENodeGenerator",
    "NrecentfastHinSAGENodeGenerator",
    "NrecentfastFilterHinSAGENodeGenerator",
...
class TimeHinSAGENodeGenerator(BatchedNodeGenerator):
    """Keras-compatible data mapper for Heterogeneous GraphSAGE (HinSAGE)
    ...
    def __init__(
        ...
        # Create sampler for HinSAGE
        self.sampler = TimeSampledHeterogeneousBreadthFirstWalk(
            G, graph_schema=self.schema, seed=seed
        )
    ...
    def sample_features(self, head_nodes, batch_num):
        ...
        """
        # Get sampled nodes
        node_samples = self.sampler.run(nodes=head_nodes, n=1, n_size=self.num_samples, start_time=self.start_time, end_time=self.end_time)
...
class NrecentfastHinSAGENodeGenerator(BatchedNodeGenerator):
    """Keras-compatible data mapper for Heterogeneous GraphSAGE (HinSAGE)
    ...
    def __init__(
        ...
        # Create sampler for HinSAGE
        self.sampler = NrecentfastHeterogeneousBreadthFirstWalk(
            G, graph_schema=self.schema, seed=seed
        )
...
class NrecentfastFilterHinSAGENodeGenerator(BatchedNodeGenerator):
    """Keras-compatible data mapper for Heterogeneous GraphSAGE (HinSAGE)
    ...
    def __init__(
        ...
        # Create sampler for HinSAGE
        self.sampler = NrecentfastFilterHeterogeneousBreadthFirstWalk(
            G, graph_schema=self.schema, seed=seed
        )
...
class NrecentHinSAGENodeGenerator(BatchedNodeGenerator):
    """Keras-compatible data mapper for Heterogeneous GraphSAGE (HinSAGE)
    ...
    def __init__(
        ...
        # Create sampler for HinSAGE
        self.sampler = NrecentHeterogeneousBreadthFirstWalk(
            G, graph_schema=self.schema, seed=seed
        )
